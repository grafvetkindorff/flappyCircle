...
namespace MathHelper
{
	...
	inline static Matrix4 StayModelMatrix()
	{
	...
	inline static Matrix4 MoveModelMatrix(int axis, float delta)
	{
		return Matrix4(1.0f, 0.0f, 0.0f, 0.0f,
	...
	inline static float get_random(float from, float to)
	{
		static std::default_random_engine e;
		static std::uniform_real_distribution<> dis(from, to); // rage 0 - 1
		return dis(e);
	}
}